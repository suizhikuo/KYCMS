<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateInfo.aspx.cs" Inherits="user_info_UpdateInfo" %>
         ...
         <table class="editborder" cellspacing="1" cellpadding="0" width="99%" border="0" align="center">
            ...
            <tr>
                ...
                <td class="bqright" align="center">
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    <asp:Button ID="Button2" runat="server" Text=" 保存修改 " CssClass="btn" OnClick="Button2_Click" />
                    &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                    <input id="Button3" type="button" value=" 取 消 " class="btn" /></td>
            </tr>
        </table>
        <script>
            GetModelHtmlUser('<%=Request.QueryString["ChId"] %>','<%=Request.QueryString["Id"] %>');
        </script>
    </form>
</body>
</html>
