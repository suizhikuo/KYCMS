<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddInfo.aspx.cs" Inherits="user_info_AddInfo" %>
   ...
   <iframe width="260" height="165" id="colorPalette" src="../../common/setcolor.htm" style="visibility: hidden; position: absolute; border: 1px gray solid; left: 2px; top: 1px;" frameborder="0" scrolling="no"></iframe>      
    <table width="99%" border="0" cellpadding="0" cellspacing="0" class="wzdh" align="center">
            <tr>
                ...
                <td>
                    您现在的位置： <a href="../Welcome.aspx">用户管理</a> >> <a href="infolist.aspx?ChId=<%=Request.QueryString["ChId"] %>">稿件管理</a> >> 添加稿件</td>
         ...
         <table class="editborder" cellspacing="1" cellpadding="0" width="99%" border="0" align="center">
            <tbody id="Tabs0">
                ...
                <tr>
                    ...
                    <td class="bqright">
                        <asp:TextBox ID="txtTitle" runat="server" Text='' Width="35%" MaxLength="30"></asp:TextBox><span
                            class="red">*</span>&nbsp;
                ...
                <tr>
                    <td class="bqleft">
                        所属栏目：</td>
                    <td class="bqright">
                        <select name="ddlColId" onchange="SetParamuser()">
                            <%
                                DataTable dt = ColumnBll.GetFormatListItemByChannelId(ChannelId);
                            Response.Write("<option value=\"0\" selected>请选择栏目</ption>");
                            foreach (DataRow dr in dt.Rows)
                            {
                                string colName = dr["ColName"].ToString();
                                int colId = Convert.ToInt32(dr["ColId"]);
                                bool flag = ColumnBll.ChkHasChildByColId(colId);
                                bool columnFlag = UserGroupBll.Power_ColumnPower(ChannelId, colId, UserGroupModel.ColumnPower, 3);
                                if ((flag && !ColumnBll.GetColumn(colId).IsAllowAddInfo) || !columnFlag)
                                {
                                    if (colId == ColumnId)
                                        Response.Write("<option value=\"" + ColumnId + "\" style=\"background-color:red\" selected>" + colName + "</option>");
                                    else
            ...
            <tr>
                ...
                <tr>
                    <td class="bqleft">
                        TAG关键字：</td>
                    <td class="bqright">
                        <asp:TextBox ID="txtTagNameStr" runat="server" Text='' Width="361px" MaxLength="100"> </asp:TextBox>&nbsp;多个关键字用"<a
                            href="javascript:SepTagName()">&nbsp;<span style="color: #00f; font-weight: 600">|</span>&nbsp;</a>"分开</td>
                </tr>
            ...
            <tr>
                ...
                <td class="bqright" align="center">
                    ...
                    &nbsp; &nbsp; &nbsp; &nbsp;<asp:Button ID="btnSaveCaoGao" runat="server" CssClass="btn"
                        OnClick="Button2_Click" Text=" 保存草稿 " />
                    &nbsp; &nbsp;&nbsp;
                    <input id="Button3" type="button" value=" 取 消 " class="btn" onclick="window.location.href='InfoList.aspx?ChId=<%=Request.QueryString["ChId"] %>';" /></td>
            </tr>
        </table>
    </form>
</body>
