<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateInfoCustomForm.aspx.cs"
    Inherits="system_infomodel_UpdateInfoCustomForm" %>
        ...
        <tr>
            ...
            <td align="left" style="padding-top: 3px;">
                您现在的位置：<a href="../SystemInfo.aspx">后台管理</a> &gt;&gt; <a href="CustomFormList.aspx">
                    表单管理</a> &gt;&gt; <a href="CustomFormInfoList.aspx?CustomFormId=<%=Request.QueryString["CustomFormId"] %>"><asp:Label ID="CustomFormName" runat="server" Text="Label"></asp:Label>信息列表</a> >> 修改信息</td>
        ...
        <table class="border" cellspacing="1" cellpadding="0" width="99%" border="0" align="center">
            ...
            <tr>
                ...
                <td class="bqright" height="50">
                    <asp:Button ID="Button1" runat="server" Text=" 确认修改 " CssClass="btn" OnClick="Button1_Click" /></td>
            </tr>
        </table>
    </form>
</body>
