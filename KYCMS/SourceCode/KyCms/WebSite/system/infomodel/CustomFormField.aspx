<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustomFormField.aspx.cs"
    Inherits="system_infomodel_CustomFormField" %>
    ...
    <form id="form1" runat="server">
        <table width="99%" cellspacing="1" cellpadding="0" class="wzdh" align="center">
            <tr>
                ...
                <td align="left" style="padding-top: 3px;">
                    ...
                    >> <a href="CustomFormFieldList.aspx?CustomFormId=<%=Request.QueryString["CustomFormId"] %>">
                        字段列表</a> >> 添加[<asp:Label ID="FormName" runat="server" Text="Label"></asp:Label>]表单字段</td>
        ...
        <table class="border" cellspacing="1" cellpadding="0" width="99%" border="0" align="center">
            ...
            <tr class="tdbg">
                ...
                <td class="bqright">
                    <asp:TextBox ID="Name" MaxLength="50" runat="server"></asp:TextBox><font color="#ff0066">*</font>注：字段名由字母、数字、下划线组成
                </td>
            </tr>
            <tr class="tdbg">
                <td class="bqleft">
            ...
            <tr>
                ...
                <td class="bqright" height="50">
                    ...
                    &nbsp;&nbsp;
                    <input id="Button2" type="button" value=" 返回字段列表 " class="btn" onclick="javascript:window.location.href='CustomFormFieldList.aspx?CustomFormId=<%=Request.QueryString["CustomFormId"] %>'" /></td>
            </tr>
        </table>
    </form>
</body>
