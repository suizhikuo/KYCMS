<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddModelField.aspx.cs" Inherits="system_infomodel_AddModelField" %>
        ...
        <table class="border" cellspacing="1" cellpadding="0" width="99%" border="0" align="center">
            ...
            <tr class="tdbg">
                ...
                <td class="bqright">
                    <asp:TextBox ID="Name" MaxLength="50" runat="server"></asp:TextBox><font
                        color="#ff0066">*</font><span class="tips">字段名由字母、数字、下划线组成 如：Title</span>
                </td>
            </tr>
            <tr class="tdbg">
                <td class="bqleft">
            ...
            <tbody id="DivMultipleTextType" style="display:none">
                <tr>
                    ...
                    <td class="bqright"><asp:TextBox ID="MultipleTextType_Width" runat="server" Columns="10" MaxLength="4">500</asp:TextBox>px</td>
                </tr>
                <tr>
            ...
            <tbody id="DivMultipleHtmlType" style="display:none">
                ...
                <tr>
                    <td class="bqleft">显示的宽度：</td>
                    <td class="bqright"><asp:TextBox ID="MultipleHtmlType_Width" runat="server" Columns="10" MaxLength="4">715</asp:TextBox>px</td>
                </tr>
                <tr>
                    <td class="bqleft">显示的高度：</td>
                    <td class="bqright"><asp:TextBox ID="MultipleHtmlType_Height" runat="server" Columns="10" MaxLength="4">400</asp:TextBox>px</td>
                </tr>
            </tbody>
            ...
            <tbody id="DivSanLinkageType" style="display:none">
                <tr>
                    <td class="bqleft">指定一级分类：</td>
                    <td class="bqright"><asp:TextBox ID="SanLinkage_Value" runat="server" style="display:none"></asp:TextBox><asp:TextBox ID="SanLinkage_Value_Show" runat="server" Columns="10"></asp:TextBox><input id="Button6" type="button" value="从数据字典中选择分类" class="btn" onclick="SelectDictionary('SanLinkage_Value','2')" /> <font color=red>注：请确认数据字典中具有三级分类</font></td>
                </tr>
                ...
                <tr>
                    <td class="bqleft">二级分类字段名：</td>
                    <td class="bqright"><asp:TextBox ID="SanLinkage_Er_Name" runat="server"></asp:TextBox> <font color="red">*</font>字段名由字母、数字、下划线组成</td>
                </tr>
                <tr style="display:none">
                ...
                <tr>
                    ...
                    <td class="bqright"><asp:TextBox ID="SanLinkage_San_Name" runat="server"></asp:TextBox> <font color="red">*</font>字段名由字母、数字、下划线组成</td>
                </tr>
            </tbody>
            <tr>
                <td class="bqleft">
