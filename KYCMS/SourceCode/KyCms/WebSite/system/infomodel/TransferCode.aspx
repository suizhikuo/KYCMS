<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TransferCode.aspx.cs" Inherits="system_infomodel_TransferCode" %>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>自定义表单JS调用代码</title>
            ...
            <tr>
                <td>
                    <table cellpadding="2" cellspacing="0" class="border" border="0" width="99%" align="center">
                        <tr class="title">
                            <td align="center">
                                <asp:Label ID="FormName" runat="server" Text="Label"></asp:Label>JS调用代码
                            </td>
                        </tr>
                        <tr>
                            <td>
