<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModelPreView.aspx.cs" Inherits="system_infomodel_ModelPreView" %>
    ...
    <form id="form1" runat="server">
        ...
        <table class="editborder" cellspacing="1" cellpadding="0" width="99%" border="0"
            ...
            <tbody id="Tabs0">
                ...
                <tr>
                    ...
                    <td class="bqright">
                        ...
                        <input type="button" class="btn" value="文章标题重名检测" />
                    </td>
                </tr>
                <tr>
                    <td class="bqleft">
                ...
                <tr>
                    <td class="bqleft">
                        TAG关键字：</td>
                    <td class="bqright">
                        <asp:TextBox ID="txtTagNameStr" runat="server" Text='' Width="361px" MaxLength="100"> </asp:TextBox>&nbsp;<span
                            class="tips"> <a href="javascript:SepTagName()">多个关键字用"&nbsp;<span style="color: #00f;
                                font-weight: 600">|</span>&nbsp;"分开</a>(每个关键字长度不能超过20个字)</span></td>
                </tr>
                <tr>
                    <td class="bqleft">
                        属性设置：</td>
            ...
            <tr>
                ...
                <td class="bqright" align="center"><input id="Button3" type="button" value=" 返 回 " class="btn" onclick="window.location.href='FieldList.aspx?ModelId=<%=Request.QueryString["ModelId"] %>'" /></td>
            </tr>
        </table>
    </form>
</body>
