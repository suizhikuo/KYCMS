<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TransferCodeHtml.aspx.cs" Inherits="system_infomodel_TransferCodeHtml" %>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>自定义表单HTML调用代码</title>
    <link href="../css/default.css" type="text/css" rel="stylesheet" />
    <script src="../../js/Common.js" type="text/javascript"></script>
</head>
<body>
    <form id="form1" runat="server">
        <table cellpadding="4" cellspacing="0" border="0" width="594" align="right">
            <tr>
                <td>
                    <table cellpadding="2" cellspacing="0" class="border" border="0" width="99%" align="center">
                        ...
                        <tr>
                            <td>
                                <asp:TextBox ID="TextBox1" runat="server" Columns="50" Rows="24" TextMode="MultiLine"
