<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PowerColumn.aspx.cs" Inherits="system_user_PowerColumn" %>
        ...
        <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border" align="center">
                    ...
                    <table width="99%" border="0" cellpadding="0" cellspacing="1" class="qxborder" align="center">
                        <tbody>
                            ...
                            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                                ...
                                <td align="left"><asp:CheckBox ID="PCId_35" runat="server" /><%=GetPowerColumn(35)%></td>
                                <td align="left">
                                ...
                                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                                    ...
                                    <td>
                                        ...
                                        <input id="ChIdColumnId_<%# Eval("TableNum") %>_1" name="ChIdColumnId_<%# Eval("TableNum") %>_1"
                                            onclick="SelectCancel('1','<%# Eval("TableNum") %>')" type="checkbox" value="1"></td>
                                    <td>
                                        <input type="checkbox" name='ChIdColumnId_<%# Eval("TableNum") %>_2' value="1" onclick="SelectCancel('2','<%# Eval("TableNum") %>')"></td>
                                    <td>
                                        <input type="checkbox" name="ChIdColumnId_<%# Eval("TableNum") %>_3" value="1" onclick="SelectCancel('3','<%# Eval("TableNum") %>')"></td>
                                    <td>
                                        
                                        <input type="checkbox" name='ChIdColumnId_<%# Eval("TableNum") %>_4' value="1" onclick="SelectCancel('4','<%# Eval("TableNum") %>')"></td>
                                    <td>
                                        <%# GetSelectBox(int.Parse(DataBinder.Eval(Container, "DataItem.ChId", "{0}")),int.Parse(DataBinder.Eval(Container, "DataItem.ColId", "{0}")))%>
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
            ...
            <tr>
                <td height="29" colspan="2" align="center">
                    <span class="STYLE1">
                        <asp:Button ID="Button1" runat="server" CssClass="btn" Text=" 保存设置 " OnClick="Button1_Click"  OnClientClick=" return CheckValidate()"/>&nbsp;
