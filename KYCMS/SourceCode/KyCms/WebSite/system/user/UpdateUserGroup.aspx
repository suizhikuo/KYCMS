<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateUserGroup.aspx.cs"
    Inherits="system_user_UpdateUserGroup" %>
        ...
        <table width="99%" border="0" cellpadding="2" cellspacing="1" class="editborder"
            ...
            <tbody id="Tabs0">
                ...
                <tr>
                    ...
                    <td class="bqright">投稿时获取积分为栏目设置的<asp:TextBox ID="Contribute_0" runat="server" Columns="4" MaxLength="4"
