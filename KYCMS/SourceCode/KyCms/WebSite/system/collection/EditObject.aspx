<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditObject.aspx.cs" Inherits="system_collection_EditObject" %>
...
<head runat="server">
    ...
    function CodePre(val)
    {
        ...
        system_collection_EditObject.CodePre(val,CodePre_CallBack);
    }
    ...
    function CollectionTest(val)
    {
        ...
        system_collection_EditObject.CollectionTest(val,CollectionTest_CallBack);
    }
    ...
    function CollectionTest_CallBack(res)
    {
		if(res.value!="null")
			...
			$("txtCollectionTest").value="请检查参数据设置";
    }
   ...
   function CreateHtml()
   {
      ...
      {
        tableBody=tableBody+"<tr><td class=\"bqleft\">"+Arr[i]+"：</td><td class=\"bqright\">开始代码：</td><td class=\"bqright\"><textarea id=\""+NameArr[i]+"Start\"  name=\""+NameArr[i]+"Start\" /></textarea></td><td class=\"bqright\">结束代码：</td><td class=\"bqright\"><textarea id=\""+NameArr[i]+"End\" name=\""+NameArr[i]+"End\" /></textarea></td><td class=\"bqright\">&nbsp;<input type=\"button\" value=\"测试\" class=\"btn\" name=\""+NameArr[i]+"\" id=\""+NameArr[i]+"\" title=\""+Arr[i]+"\" onclick=\"TestContent(this)\" /></td><td class=\"bqright\">默认值：</td><td class=\"bqright\"><input type=\"text\" name=\""+NameArr[i]+"Default\" style=\"width:85px;\" /></td></tr>\r\n"
      }
	...
	function setChecked()
	{
		...
		CreateHtml();
		var FieldStr=$("hidFieldValue").value;
		var FieldArr=FieldStr.split('|');
		for(i=0;i<FieldArr.length-1;i++)
		{
			$(FieldArr[i].split(',')[0]+"Start").value=FieldArr[i].split(',')[1];
			$(FieldArr[i].split(',')[0]+"End").value=FieldArr[i].split(',')[2];
			$(FieldArr[i].split(',')[0]+"Default").value=FieldArr[i].split(',')[3];
		}
	}
	...
	function CheckCodeFun(obj)
	{
		...
		checkCodeStr="";
		if(obj.id=="btnStartCheck")
		{
			checkCodeStr=$("txtListStart").value;
		}
		else if(obj.id=="btnEndCheck")
		{
			checkCodeStr=$("txtListEnd").value;
		}
    ...
    {
        system_collection_EditObject.CheckHtmlCode(val,CheckCode_CallBack);
    }
    ...
    {
        system_collection_EditObject.CheckContentCode(val,CheckContentCode_CallBack);
    }
    ...
    function FieldPre(val)
    {
        ...
        system_collection_EditObject.FieldPre(val,FieldPre_CallBack);
		...
		<table id="baseTable" width="99%" align="center" class="border" cellspacing="1" cellpadding="0">
		   <tbody>
				...
				<tr>
				  ...
				  <td class="bqright">
					  <asp:RadioButtonList ID="rdoCharSet" runat="server" RepeatDirection="Horizontal">
			  ...
			  <tbody id='Tabs'>
				   <tr>
					  ...
					  <td class="bqright">
						  ...
						  <input id="btnStartCheck" type="button" value="测试代码" class="btn" onclick="CheckCodeFun(this)" />
					  </td>
					</tr>
					...
					<tr>
					  ...
					  <td class="bqright">
						  ...
						  <span style="color:Red">*</span>
						  <input id="btnEndCheck" type="button" value="测试代码" class="btn" onclick="CheckCodeFun(this)" />
						</td>
					</tr>
					...
					<tbody id='Tabs' style='display:none'>
						<tr>
							  <td class="tdbg" colspan="2" >
								...
								<div style="text-align:left"><span style="color:#0099FF">注：由于考虑到数据量，只列出第一个列表页</span></div>
							 </td>
						</tr>
					</tbody>
           ...
           <tbody>
			...
			<table id="conTable2" width='99%' border='0' align='center' cellpadding='0' cellspacing='1' class='editborder' style="display:none;">
								 ...
								 <tr>
									...
									<td class="bqright">
										<table>
											<tr>
												<td width="160px">
													<asp:ListBox ID="lbFildList" runat="server" Height="180" Width="160" SelectionMode="Multiple" onChange="CreateHtml();setChecked()"></asp:ListBox>
												</td>
												<td align="left" valign="top" width="100%" style="display:none;">
													<table width="100%">
														<tr>
															<td width="21%"><b>测试代码预览：</b></td>
															<td width="79%"><asp:TextBox ID="txtFieldPre" runat="server" TextMode="multiLine" Width="100%" Height="165px"></asp:TextBox></td>
														</tr>
													</table>
												</td>
											</tr>
					...
					<tr id="ConPaing1" style="display:none;">
					 <td class="bqleft">“下一页”<br />URL开始代码：<br/><br/><br/><br/><br/><br/>
					  ...
					  <td class="bqright">
						  ...
						  <input type="button" value='测试代码' class="btn" onclick="CheckContentFun(txtConPageStart)" /><br/>
				...
				<tbody id='Tabs' style='display:none'>
				  <tr>
					...
					<td class="bqright">
						<asp:CheckBoxList ID="chkSimpleFilter" runat="server" name="chkSimpleFilter">
				...
				<tr>
				   ...
				   <td class="bqright">
					   <asp:ListBox ID="lbFilterRule" runat="server" Height="150px" SelectionMode="Multiple" Width="120px"></asp:ListBox><br />						
						复杂规则,用于过滤广告等信息.
					</td>
				</tr>
			</tbody>
			...
			<tr>
				<td colspan="2" align="center">
					...
					<asp:Button ID="btnSave" runat="server" Text=" 修 改  " CssClass="btn" OnClientClick="return ValidateConPage()" OnClick="btnSave_Click" />
				</td>
			</tr>
    </table>
